...
# Note: Streamlit automatically handles camera start/stop and processing.
# You don't need to manually release the camera or destroy windows as you would in a standalone script.
```